...
export default function Navbar(props) {
  ...
  return (
    <>
      <Box sx={{ flexGrow: 1 }}>
        <AppBar position="static" color="default">
          <Toolbar disableGutters>
            ...
            <Box sx={{ display: { xs: "flex", md: "none" } }}>
              <Link to="/cart" style={{ textDecoration: "none" }}>
                <IconButton
                  ...
                  sx={{ m: 1 }}
                >
                  <Badge badgeContent={props.cart.totalQuantity} color="info">
                    <ShoppingCartIcon />
                  </Badge>
                </IconButton>
              </Link>
            ...
            <Box
              sx={{ display: { xs: "none", md: "flex", flexGrow: 1 }, mr: 1 }}
            >
              <img src={Logo} alt="logo" />
            </Box>
      ...
      <Searchbar fishList={props.fishList} />
    </>
  );
}
