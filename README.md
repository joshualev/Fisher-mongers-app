...
We were certain from the start the objective would be to create a commerce app that allowed access to a database and a shopping cart. Some ideas discussed:
